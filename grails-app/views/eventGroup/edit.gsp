...
<html>
	...
	<body>
		<a href="#edit-eventGroup" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-eventGroup" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:eventGroupInstance, action:'update']" method="PUT" >
